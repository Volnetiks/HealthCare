...
class StatsItem extends StatelessWidget {
  const StatsItem({super.key, required this.icon, required this.title, required this.value, required this.iconColor});
    ...
    return Container(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            RoundedIcon(color: Colors.white, icon: icon, iconColor: iconColor),
            Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
